...
function ModalAjoutCategorie({ onClose, onSaved }) {
    ...
    const modalNode = (
        <div
            ...
            role="presentation"
        >
            <div className="modalCategorie-panel" role="dialog" aria-modal="true" aria-labelledby="modalCategorie-title">
                {success ? (
                    ...
                    <>
                        ...
                        <form onSubmit={handleSubmit} noValidate>
                            <div className="modalCategorie-body">
                                ...
                                <div className="modalCategorie-field">
                                    <label className="modalCategorie-label" htmlFor="cat-desc">
                                        Description
                                    </label>
                                    <textarea
                                        id="cat-desc"
