...
class EntrepriseController extends Controller
{
    ...
    private function getRoleIcon(string $roleName): string
    {
        $map = [
            ...
            'gérant'                   => 'LayoutDashboard',
            'gerante'                  => 'LayoutDashboard',
            'caissier'                 => 'Banknote',
            'caissière'                => 'Banknote',
            'vendeur'                  => 'ShoppingBag',
            'vendeuse'                 => 'ShoppingBag',
            'livreur'                  => 'Truck',
            'livreuse'                 => 'Truck',
            'comptable'                => 'Calculator',
            'rh'                       => 'Users',
            'ressources humaines'      => 'Users',
            'responsable stock'        => 'Package',
            'responsable des stocks'   => 'Package',
            'magasinier'               => 'Package',
            'admin'                    => 'Shield',
            'administrateur'           => 'Shield',
            'administratrice'          => 'Shield',
            'superviseur'              => 'Eye',
            'superviseure'             => 'Eye',
            'technicien'               => 'Wrench',
            'technicienne'             => 'Wrench',
            'chef d\'equipe'           => 'UserCog',
            'chef d\'équipe'           => 'UserCog',
            'responsable'              => 'BriefcaseBusiness',
            'responsable commercial'   => 'BriefcaseBusiness',
            'responsable marketing'    => 'Megaphone',
