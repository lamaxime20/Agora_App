...
import CommandeTable from '../../components/commercial/commandeTableCommercial.jsx';
import { createContext, useState } from 'react';

export const CommandesContext = createContext();

const CommandePageCommercial = ({ commercialId = 'Commercial 1' }) => {
          ...
          <NotificationProvider>
            ...
            <Container fluid className="p-3 mt-md-0">
              <Card className="shadow-sm border-light">
                <Card.Body>
                  <CommandesContext.Provider value={{ filters, setFilters }}>
                    <Row className="mb-3 align-items-end">
                      <Filters filterConfig={filterConfig} context={CommandesContext} />
                      <CommandeTable commercialId={commercialId} />
                    </Row>
...
export default CommandePageCommercial;