...
import LivraisonTable from '../../components/commercial/livraisonTableCommercial.jsx';
import { createContext, useState } from 'react';

export const LivraisonsContext = createContext();

const LivraisonPageCommercial = ({ commercialId = 'Commercial 1' }) => {
          ...
          <NotificationProvider>
            ...
            <Container fluid className="p-3 mt-md-0">
              <Card className="shadow-sm border-light">
                <Card.Body>
                  <LivraisonsContext.Provider value={{ filters, setFilters }}>
                    <Row className="mb-3 align-items-end">
                      <Filters filterConfig={filterConfig} context={LivraisonsContext} />
                      <LivraisonTable commercialId={commercialId} />
                    </Row>
...
export default LivraisonPageCommercial;