...
import NotificationsPage from '../../pages/commercial/notificationPage';
import { useNotification } from '../manager/notificationContext';
import { useLocation } from 'react-router-dom';

const SousHeaderCommercial = () => {
  const { showModal, openModal, closeModal, selectedNotification } = useNotification();
  const location = useLocation();

  // Mapper les chemins d'URL aux titres des pages pour les commerciaux
  const pageTitles = {
    '/commercial/dashboard': 'DASHBOARD',
    '/commercial/clients': 'CLIENTS & PROSPECTS',
    '/commercial/dossiers': 'DOSSIERS',
    '/commercial/commandes': 'COMMANDES',
    '/commercial/factures': 'FACTURES',
    '/commercial/livraisons': 'LIVRAISONS',
    '/commercial/rapports': 'RAPPORTS DE VISITES',
    '/commercial/agenda': 'AGENDA',
  };
  ...
  return (
    <Card
      className="shadow-sm mt-5 mt-md-2"
      style={{ marginLeft: '15px', marginRight: '15px', borderColor: 'white' }}
    >
...
export default SousHeaderCommercial;