...
const HeaderCommercial = () => {
  ...
  const navItems = [
    { to: "/commercial/dashboard", label: "Dashboard", eventKey: "/commercial/dashboard" },
    { to: "/commercial/clients", label: "Mes Clients & Prospect", eventKey: "/commercial/clients" },
    { to: "/commercial/dossiers", label: "Dossiers", eventKey: "/commercial/dossiers" },
    { to: "/commercial/commandes", label: "Commande", eventKey: "/commercial/commandes" },
    { to: "/commercial/factures", label: "Factures", eventKey: "/commercial/factures" },
    { to: "/commercial/livraisons", label: "Livraisons", eventKey: "/commercial/livraisons" },
    { to: "/commercial/rapports", label: "Rapports de Visite", eventKey: "/commercial/rapports" },
    { to: "/commercial/agenda", label: "Agenda", eventKey: "/commercial/agenda" },
  ];
